...
The dataset contains 517 observations from the Montesinho region of Portugal.

The `area` variable is converted into a binary target:
...
├── ForestFire_RiskPrediction.ipynb
└── README.md
~~~
